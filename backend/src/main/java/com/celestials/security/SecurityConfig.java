...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring().requestMatchers("/api/payments/stripe/webhook");
    }
    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception{
        http
            ...
            .authorizeHttpRequests(authz -> authz
                .requestMatchers("/api/auth/**","/api/products","/api/products/*","/api/product-types","/api/blogs/published","/api/blogs/*","/api/payments/netopia/**","/api/discount-codes/**","/api/settings","/v3/api-docs/**","/swagger-ui/**","/swagger-ui.html","/health").permitAll()
